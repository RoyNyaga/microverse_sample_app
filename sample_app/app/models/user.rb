class User < ApplicationRecord
  ...
  def create_reset_digest
    ...
    # THE CODE BELOW WORKS BUT HITS THE DATABASE TWO TIMES WHICH IS NOT THE BEST IDEA,
    # update_attribute(:reset_digest,  User.digest(reset_token)) 
    # update_attribute(:reset_sent_at, Time.zone.now)
    # TO ENSURE THAT WE OBTAIN THE INFORMATION WE WANT BY HITING THE DABASE ONESE WE USE THE FOLLOWING CODE
